...
func GetLiveStatsPokemon() *ApiPokemonLiveStatsResult {
	...
	log.Infof("apiLiveStats - PokemonCache Oldest ExpiredTimestamp : %d pokemon_active_oldest_expiry, %s time ago", liveStats.PokemonOldestExpiry, time.Since(liveStats.PokemonOldestExpiry))
